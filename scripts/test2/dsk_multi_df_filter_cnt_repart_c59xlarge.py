...
LOGGER.info('START: Repartitioning df1 with 20 parts')
df1 = df1.repartition(npartitions=20)
LOGGER.info('START: Repartitioning df1 with 20 parts')
...
LOGGER.info('START: Repartitioning df2 with 20 parts')
df2 = df2.repartition(npartitions=20)
LOGGER.info('START: Repartitioning df2 with 20 parts')
...
cnt = cnt.compute(num_workers=20)
